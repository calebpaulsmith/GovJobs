...
- [x] **D.5.29 — Shareable view URLs (per ADR-0033).** *(Shipped 2026-06-11; WebKit-verified. Requires a one-time Cloudflare KV binding for short links — see `docs/REMOTE_OPERATIONS.md`; the button falls back to the long URL until then.)*
