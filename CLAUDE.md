...
7. **No advanced features in V1.** No React, FastAPI, Docker, cloud deployment, user accounts, vector DB, paid APIs, browser scraping, or auto-applications. See `docs/ROADMAP.md` for what belongs where.
